...
const Footer = ({ theme }) => {
  return (
    <div className="bg-slate-50 dark:bg-gray-900 pt-10 sm:pt-10 mt-20 sm:mt-40 px-4 sm:px-12 lg:px-24 xl:px-40">
      {/* footer top  */}
      <div className="flex justify-between lg:items-center max-lg:flex-col gap-10 ">
        ...
        <div className="text-gray-600 dark:text-gray-400">
          ...
          <p className="text-sm mt-2 mb-6">
            The latest news,articles and resources, sent ti your inbox weekly.
          </p>
      ...
      <hr className="border-gray-300 dark:border-gray-600 my-6"/>
        ...
        <div className="pb-6 text-sm text-gray-500 flex justify-center sm:justify-between gap-4 flex-wrap">
          <p>Copyright 2025 @ Dharmesh Patel. All Rights Reserved </p>
