...
const ContactUs = () => {
  ...
  const onSubmit = async (event) => {
    ...
    formData.append("access_key", "ba015167-00ed-48ab-a351-3d664fb9fac8");
  ...
  return (
    ...
    >
      <Title
        ...
        description="From strategy to execution,We craft digital solutions that moves your business forward."
      />
      ...
      <div className="sm:col-span-2">
        ...
        <textarea name="message" id="" rows={8} placeholder="Enter Your message" className="w-full p-3 text-sm outline-none rounded-lg border border-gray-300 dark:border-gray-600 " />
      </div>
